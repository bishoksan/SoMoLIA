...
//            model.getEnv().set(GRB.IntParam.Presolve, 1); //http://www.gurobi.com/documentation/6.5/refman/presolve.html
    ...
    public void parseConstraint(GRBConstr c) {
        try {
...
//    public HashMap<String, Long> getGRBModel(GRBModel model) {
//        HashMap<String, Long> varModel = new HashMap<String, Long>();
//        try {
//            model.computeIIS();
//            for (GRBVar v : model.getVars()) {
//                varModel.put(v.get(GRB.StringAttr.VarName), (long) v.get(GRB.DoubleAttr.X));
//            }
//        } catch (GRBException ex) {
//        }
//        return varModel;
