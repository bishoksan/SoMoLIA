...
public class Util {
    ...
    public static HashSet<IntExpr> collectVars(Expr e) {
    ...
    public static void collectVars1(Expr e, HashSet<IntExpr> set) {
    ...
    public static HashSet<IntExpr> varUnion(HashSet<IntExpr> set1, HashSet<IntExpr> set2) {
        for (IntExpr ie : set2) {
            set1.add(ie);
        }
        return set1;
...
//    public static void collectVars1(Expr e, HashSet<IntExpr> set) {
//        if (e.isVar()) {
//            //System.out.println("is var " + e);
//            set.add((IntExpr) e);
//
//        } else if (e.isQuantifier()) {
//            // System.out.println("is quant " + e);
//
//        } else if (e.isApp()) {
//            // System.out.println(e+" is application");
//            if (e.getNumArgs() == 0 && e.isInt()) {
//                //System.out.println(e+" is a variable");
//                set.add((IntExpr) e);
//            } else {
//                Expr[] exprs = e.getArgs();
//                for (int i = 0; i < exprs.length; i++) {
...
//    }
     ...
     */
    public static HashMap<IntExpr, GRBVar> getGRBVars(GRBModel model, HashSet<IntExpr> z3Vars) {
        HashMap<IntExpr, GRBVar> z3GRBVarMap = new HashMap<>();
        for (IntExpr ie : z3Vars) {
            z3GRBVarMap.put(ie, getGRBVar(model, ie, min_neg(), max_pos()));
        }
        return z3GRBVarMap;
    }

    public static GRBVar getGRBVar(GRBModel model, IntExpr z3Var, double lower, double upper) {
        GRBVar var = null;
...
//                    System.out.println(" constr ============= " + GurobiInterface.constrString(grbExpr0, "<=", grbExpr1));
                    // System.out.println("adding c"+ grbExpr0);
    ...
    public static GRBLinExpr z3Expr2GRBExpr(ArithExpr e, GRBModel model, HashMap<IntExpr, GRBVar> z3GRBVarMap) {
        ...
        try {
            if (e.isIntNum()) {//constant
                ...
                // System.out.println(e+" is application");
                if (e.getNumArgs() == 0 && e.isInt()) { //variable
